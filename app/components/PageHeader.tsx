export default function PageHeader() {
  return (
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-gray-900 border-b border-gray-700 text-sm py-2.5 sm:py-4">
      <nav
        className="flex items-center w-full px-4 mx-auto max-w-7xl basis-full sm:px-6 lg:px-8"
        aria-label="Global"
      >
        ...
        <div className="flex items-center justify-end w-full ms-auto sm:justify-between sm:gap-x-3 sm:order-3">
          ...
          <div className="hidden mx-auto sm:block">
            ...
            <div className="relative">
              ...
              <input
                ...
                id="icon"
                name="icon"
                className="block px-4 py-2 text-sm text-gray-300 bg-transparent border-gray-700 rounded-lg shadow-sm ps-11 pe-20 w-92 md:w-96 focus:z-10 focus:border-gray-900 focus:ring-gray-600 placeholder:text-gray-500"
                placeholder="Search"
              />
          ...
          <div className="flex flex-row items-center justify-end gap-2">
            ...
            <div
              className="relative inline-flex hs-dropdown"
